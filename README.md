...
2. Breakdown of Your Implementation:
...
1. Setup a Network Attached Storage (NAS). You can search around for different solutions, here is one example tutorial for TrueNAS on VM.
...
3. Leverage Connection for Distributed Computing - 
